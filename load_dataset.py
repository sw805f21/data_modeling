...
path2 = "dataset_videoes\\train\\01April_2010_Thursday_heute-6694"
...
for (image, label) in merged_dataset:
    #print(image)
    print(label)

as_np = np.array(merged_dataset)
print(as_np.shape)

#tf.convert_to_tensor(merged_dataset)
...
# Get number of videoes in folder
